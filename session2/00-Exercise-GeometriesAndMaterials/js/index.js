...
//var material9 = new THREE.MeshNormalMaterial({ map: texture2 });

//var texture3 = new THREE.TextureLoader().load("textures/colors.png");
//var material10 = new THREE.MeshNormalMaterial({ map: texture3 });

var mesh1 = new THREE.Mesh( geometry, material2 );
mesh1.position.z = -1000;
mesh1.position.y = 100;

var mesh2 = new THREE.Mesh( geometry, material3 );
...
var mesh8 = new THREE.Mesh( geometry, material6 );
...
var mesh10 = new THREE.Mesh( geometry, material6 );
mesh10.position.z = -1000;
mesh10.position.x = 200;
mesh10.position.y = -100;

var mesh11 = new THREE.Mesh( geometry, material3 );
mesh11.position.z = -1000;
mesh11.position.x = -100;
mesh11.position.y = -200;

var mesh12 = new THREE.Mesh( geometry, material3 );
